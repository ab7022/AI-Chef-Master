...
const SideBar = ({ lightMode }) => {
    ...
    return (
        <div className={`fixed top-[56px] left-0 lg:relative flex flex-col lg:w-1/5 h-[calc(100dvh-56px)]  lg:mt-[-56px] lg:h-screen overflow-y-auto ${colors.background} ${colors.text}  text-white shadow-2xl `}>
            ...
            <ul className="">
               ...
               <footer className="mt-auto px-4 py-2 text-sm text-center text-gray-500">
