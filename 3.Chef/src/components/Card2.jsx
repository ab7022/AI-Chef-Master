...
const hasHalfStar = rating % 1 !== 0;
 return (
<div className="rounded-lg items-center h-[325px] flex flex-1 justify-center  flex-row md:flex-col  w-[325px]  cursor-pointer   hover:scale-110 transition-all duration-300 ">
