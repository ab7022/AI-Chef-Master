  ...
  return (
    <>
      <div className='min-h-screen md:pb-16'>
        ...
        <p className='custom-text text-2xl font-medium py-12 px-6 md:px-12 text-center md:text-left'>We are committed to pushing culinary boundaries and expanding our influence in the market. With a focus on user-centric experiences and foresight into the future, our growth-oriented vision is a testament to our strategic goals and ambitions.</p>
