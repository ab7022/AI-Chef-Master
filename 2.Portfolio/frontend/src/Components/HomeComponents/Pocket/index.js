  ...
  return (
    <div className="values-container background-style-pocket break-words text-black px-6 md:px-10 py-8 md:pt-20 text-center items-center">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-4 ">
        ...
        {/* {CardList.map((card) => ( */}
          <ChefCard key={uuidv4()} heading={"AI Assistant"} description={"Elevate your cooking into a tailored and engaging adventure. This feature directs users in creating delightful dishes by enabling customization of quantities and ingredients, unfolding the recipe seamlessly through a blend of audio, text, and video to enhance the culinary journey. For more details on how this feature can transform your cooking experience and unlock a world of possibilities in the kitchen."} video={"assets/AI_ASSISTANT.mp4"}/>
          <ChefCard key={uuidv4()} heading={"Chef Intelligence"} description={"Convert your leftover ingredients into culinary delights effortlessly. Users simply input their available ingredients, and the module generates a curated list of diverse dishes. Once a choice is made, users receive detailed cooking instructions, empowering them to effortlessly turn their kitchen odds and ends into delicious meals and enjoy your meals with the help of AI Automation."} video={"assets/Chef.mp4"}/>
          <ChefCard key={uuidv4()} heading={"Nutrition Manager"} description={"The AI Chef Master also offers a Nutrition Manager, catering to gym enthusiasts and fitness aficionados. This feature allows you to monitor your dietary intake, keeping track of what you consume and understanding how different foods can impact your body and overall well-being. Stay on top of your nutritional goals with precision and make informed choices for a healthier lifestyle."} video={"assets/Nutrition.mp4"}/>
        {/* ))} */}
    </div>
    </div>
  );
