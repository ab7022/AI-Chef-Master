...
export const ChefCard1 = ({ heading, description, video }) => {
  ...
  return (
    <div
      className={`max-w-6xl md:mt-12 flex flex-col mx-auto justify-center items-center ${themeClass}`}
    >
      <div className="flex justify-center flex-col mx-auto items-center">
        ...
        <div className="flex flex-col justify-center items-center  ">
          ...
          <p
            className={`z-10 max-w-screen p-4 flex text-lg flex-col text-justify shadow-lg shadow-gray-200 ${themeClass}`}
          >
            {description}
          </p>
        </div>
