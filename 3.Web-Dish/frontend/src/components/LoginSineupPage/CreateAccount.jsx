...
function CreateAccount() {
  ...
  return (
    <>
      <div className='flex md:flex-row flex-col bg-[#00544f] min-h-[calc(100dvh-64px)]'>
        ...
        <div className='bg-[#f7f3cd] flex flex-col justify-center lg:px-28 p-12 md:py-8 sm:px-12 md:px-16 md:w-3/5 border-black md:rounded-l-3xl'>
          ...
          <form onSubmit={handleSubmit} className="mb-4 flex flex-col gap-y-6">
            ...
            <div className="text-sm flex flex-col sm:flex-row md:flex-row gap-5">
              <select className="p-3 bg-[#f7f3cd] border rounded-lg border-black focus:outline-none sm:w-1/2 md:w-2/4">
            ...
            <div className="flex justify-center items-center">
              <button type="submit" onClick={create} className='bg-[#00544f] p-3 my-3 w-full  md:max-w-sm text-white text-2xl rounded-lg hover:scale-110 sm:text-lg sm:w-2/3  lg:w-3/4'>Create Your Account</button>
            </div>
          </form>
