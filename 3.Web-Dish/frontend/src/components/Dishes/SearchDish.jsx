      ...
      <div className="flex justify-center">
        <div className="relative w-full sm:w-1/2  ">
          ...
          <input
            ...
            className="border-2  text-sm font-medium py-2 sm:py-3 border-green-500 rounded-lg px-6 sm:px-10 text-start text-black focus:border-black outline-none w-full"
          />
