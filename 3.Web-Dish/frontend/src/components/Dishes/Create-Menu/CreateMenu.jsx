...
function CreateMenu() {
  ...
  const slides = [
    {
      imageUrl:
        "https://media.istockphoto.com/id/2061261654/photo/hands-waiter-and-writing-order-in-restaurant-for-service-hospitality-and-taking-notes-in.jpg?s=612x612&w=0&k=20&c=EO2HH5GcMZ8kdWejHa0pSm7nx6ZdcHuAIZV4B4fOT9Q=",
    },
    {
      imageUrl:
        "https://media.istockphoto.com/id/1494912650/photo/chef-working-at-a-restaurant-and-creating-a-menu.jpg?s=612x612&w=0&k=20&c=4kaEAEJKIqhptet3lHjiuaUP2OHYKn1PzQaOSD3WvyU=",
    },
    {
      imageUrl:
        "https://media.istockphoto.com/id/186558210/photo/professional-chef-in-kitchen.jpg?s=612x612&w=0&k=20&c=ZpK28W0jT0iSq-k-Z4jhuCYZryfwIoqueL55AgoRFBI=",
    },
  ];
      ...
      <div class="mt-3 grid grid-cols-1 md:grid-cols-3 gap-4 justify-items-center align-items-center md:px-2">
        <div className="flex flex-col space-y-4">
          <div className="flex flex-col mb-4 ">
            <label
              htmlFor="meal"
              className="text-[#00544f] text-lg font-bold mb-3"
            >
              Select Meal
            </label>
            <select
          ...
          <div className="flex flex-col mb-4">
            ...
            <select
              id="cuisine"
              className="px-5 py-2 w-full md:w-64 rounded-md bg-transparent border-2 border-black"
            >
          ...
          <div className="flex flex-col mb-4">
            ...
            <div className="flex justify-center w-52 md:w-36 bg-white rounded-lg p-2 ">
              <button
                ...
                className="px-4 py-2 bg-gray-200 text-black rounded-l-md text-lg font-semibold hover:bg-gray-300 transition-colors duration-300"
              >
                -
              </button>
              ...
              <button
                ...
                className="px-4 py-2 bg-gray-200 text-black rounded-r-md text-lg font-semibold hover:bg-gray-300 transition-colors duration-300"
              >
                +
              </button>
            </div>
        ...
        <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-col mb-4">
              ...
              <div className="flex flex-wrap gap-3 md:w-64">
                {Dessert.map((dish, index) => (
                  <div
                    key={index}
                    className="flex items-center border-2 border-black text-[1rem] font-medium rounded-md px-3 py-2"
                  >
                    <span className="flex-grow">{dish}</span>
                    <CiCircleRemove
                      onClick={() => removeDessert(index)}
                      className="text-bold text-black cursor-pointer hover:bg-red-200 rounded-full p-1 transition-colors duration-300"
                      size={25}
                    />
                  </div>
                ))}
              ...
              <input
                ...
                className="px-5 mb-2 mt-1 py-2 w-full md:w-64 rounded-md bg-transparent border-2 border-black"
              />
              <div className="flex justify-center">
                <button
                  onClick={addDessert}
                  className="text-[#00544f] font-bold text-lg"
                >
                  Add +
                </button>
              </div>
            ...
            <div className="flex flex-col mb-4">
              ...
              >
                ...
                <optgroup label="Functional Beverages">
                  ...
                  <option value="vitamin-enhanced-water">
          ...
          <div className="flex flex-col mb-4">
            ...
            <input
              value={newMainDish}
              onChange={handleMainDishInputChange}
              type="text"
              placeholder="Rice"
              className="px-5 mb-2 mt-1 py-2 w-full md:w-64 rounded-md bg-transparent border-2 border-black"
            />
          ...
          <div className="flex flex-col mb-4">
            ...
            <input
              value={newSideDish}
              onChange={handleSideDishInputChange}
              type="text"
              placeholder="Rice"
              className="px-5 mb-2 mt-1 py-2 w-full md:w-64 rounded-md bg-transparent border-2 border-black"
            />
          ...
          <div className="flex flex-col mb-4">
            ...
            <div className="mb-4">
              <label className="text-lg mb-2 font-semibold text-[#00544f]">
                Total Cooking Time
              </label>
              <div className="relative flex items-center">
                <button
                  className="p-2 bg-[#00544f] text-white rounded-l-md"
                ...
                />
                <button
                  className="p-2 bg-[#00544f] text-white rounded-r-md"
                  onClick={incrementTime}
                >
                  +
                </button>
                <span className="absolute inset-y-0 right-20 flex items-center text-gray-500">
                  minutes
                </span>
              </div>
            </div>
            <div className="mb-4 flex flex-col">
              <label className=" mb-2 text-lg font-semibold text-[#00544f]">
                Skill Level
              </label>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex flex-col">
            <label
              htmlFor="kitchen-equipments"
              className="text-[#00544f] text-lg font-bold mb-3"
            >
              Kitchen Equipments
            </label>
            <select
              id="kitchen-equipments"
              className="px-5 py-2 w-full md:w-64 rounded-md bg-transparent border-2 border-black"
