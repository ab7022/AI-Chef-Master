...
function HealthyDishCategories() {
  ...
  return (
    <div className="">
      <nav className=" bg-[#f7f3cd] z-50 top-0 sticky shadow-lg gap-3">
        <div className="flex flex-wrap  items-center shadow-lg justify-between   bg-white mx-auto py-3">
          ...
          <ul className="font-medium rounded-lg flex flex-col md:flex-row items-center justify-center p-4 md:p-0 mt-4 border border-gray-100 md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 sm:shadow md:shadow-none">
