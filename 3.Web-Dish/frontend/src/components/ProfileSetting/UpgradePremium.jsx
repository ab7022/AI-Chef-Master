            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl p-6 rounded-lg"> 
                    <div className="border-gray-300 bg-white shadow-md rounded-md overflow-hidden p-6">
                        ...
                        <button className="block w-full bg-teal-800 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-teal-700 focus:outline-none focus:bg-teal-700 transition duration-300 ease-in-out">Start Now</button>
