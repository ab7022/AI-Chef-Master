...
function AiFacts() {
  return (
    <div className='flex gap-y-3 pb-6 flex-col px-9 pt-6 md:mt-12 mt-4  ' style={{"backgroundImage":" linear-gradient(#D3D3D3, #FFFFFF)"
  }}>
     <div className='text-black xl:pl-[8rem]  font-bold md:pl-18 sm:text-5xl text-[1.5rem]'>Ai Chef Master Fast Facts</div>
