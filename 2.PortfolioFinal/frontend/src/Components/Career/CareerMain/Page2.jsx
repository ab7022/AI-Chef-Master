        ...
        <div className='gap-4 mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center'>
          <div className="w-80 h-80 bg-[#EEEEEE] hover:shadow-lg rounded-md border-2 hover:shadow-slate-500 ">
            ...
            <div className="flex gap-4 justify-center">
              <Button className='bg-white w-full h-16 text-black text-2xl'>Operations 🡪</Button>
            </div>
          </div>
          ...
          <div className="w-80 h-80 bg-[#EEEEEE] hover:shadow-lg rounded-md border-2 hover:shadow-slate-500 ">
            ...
            <div className="flex gap-4 justify-center">
              <Button className='bg-white w-full h-16 text-black text-2xl'><Link to="/technology" onClick={() => window.scrollTo(0, 0)}>Technology 🡪</Link></Button>
            </div>
          </div>
          ...
          <div className="w-80 h-80 bg-[#EEEEEE] hover:shadow-lg rounded-md border-2 hover:shadow-slate-500 ">
            ...
            <div className="flex gap-4 justify-center">
              <Button className='bg-white w-full h-16 text-black text-2xl'>Sale & marketing 🡪</Button>
            </div>
          </div>
          ...
          <div className="w-80 h-80 bg-[#EEEEEE] hover:shadow-lg rounded-md border-2 hover:shadow-slate-500 ">
            ...
            <div className="flex gap-4 justify-center">
              <Button className='bg-white w-full h-16 text-black text-2xl'>Design 🡪</Button>
            </div>
          </div>
          ...
          <div className="w-80 h-80 bg-[#EEEEEE] hover:shadow-lg rounded-md border-2 hover:shadow-slate-500 ">
            ...
            <div className="flex gap-4 justify-center">
              <Button className='bg-white w-full h-16 text-black text-2xl'>Internships 🡪</Button>
            </div>
          </div>
        </div>
      </div>
