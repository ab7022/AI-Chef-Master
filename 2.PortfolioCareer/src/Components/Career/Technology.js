  ...
  return (
    <div className="container-lg">
      ...
      <div className=" mx-auto my-8">
        ...
        <h1 className="text-center text-3xl md:text-4xl lg:text-5xl font-bold mb-18">
          Job Areas
        </h1>

        <div className=" w-full md:w-4/5 mx-auto bg-white mt-20 p-6 rounded-md shadow-lg">
          <div className="flex flex-col md:flex-row md:justify-start lg:justify-start items-center mb-4">
            ...
            />
            <h2 className="mt-2 md:ml-8 font-semibold text-xl md:text-2xl lg:text-3xl">
              Software
            </h2>
          </div>
