...
const TextImage = () => {
  return (
    <div className="relative bg-gray-800 h-screen flex justify-center items-center">
      ...
      <div className="relative z-10 max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-black md:mb-96">
        <p className="text-lg md:text-xl lg:text-2xl xl:text-3xl mb-44">
